...
typedef enum {
	...
	EC_NPC_ID = 44,
	EC_NPC_HOTSPOT = 45,
	EC_NPC_DIALOG_THEM = 46,
	EC_NPC_DIALOG_YOU = 47,
	EC_NPC_VOICE = 48,
	EC_NPC_DIALOG_TOPIC = 49,
	EC_NPC_DIALOG_GROUP = 50,
	EC_NPC_ALLOW_MOVEMENT = 51,
	EC_NPC_PORTRAIT_THEM = 52,
	EC_NPC_PORTRAIT_YOU = 53,
	EC_QUEST_TEXT = 54,
	EC_WAS_INSIDE_EVENT_AREA = 55,
	EC_NPC_TAKE_A_PARTY = 56
