...
typedef enum {
	...
	EC_NPC_ID = 41,
	EC_NPC_HOTSPOT = 42,
	EC_NPC_DIALOG_THEM = 43,
	EC_NPC_DIALOG_YOU = 44,
	EC_NPC_VOICE = 45,
	EC_NPC_DIALOG_TOPIC = 46,
	EC_NPC_DIALOG_GROUP = 47,
	EC_NPC_ALLOW_MOVEMENT = 48,
	EC_NPC_PORTRAIT_THEM = 49,
	EC_NPC_PORTRAIT_YOU = 50,
	EC_QUEST_TEXT = 51,
	EC_WAS_INSIDE_EVENT_AREA = 52,
	EC_NPC_TAKE_A_PARTY = 53
