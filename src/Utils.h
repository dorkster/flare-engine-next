...
typedef enum {
	...
	EC_NPC_ID = 42,
	EC_NPC_HOTSPOT = 43,
	EC_NPC_DIALOG_THEM = 44,
	EC_NPC_DIALOG_YOU = 45,
	EC_NPC_VOICE = 46,
	EC_NPC_DIALOG_TOPIC = 47,
	EC_NPC_DIALOG_GROUP = 48,
	EC_NPC_ALLOW_MOVEMENT = 49,
	EC_NPC_PORTRAIT_THEM = 50,
	EC_NPC_PORTRAIT_YOU = 51,
	EC_QUEST_TEXT = 52,
	EC_WAS_INSIDE_EVENT_AREA = 53,
	EC_NPC_TAKE_A_PARTY = 54
